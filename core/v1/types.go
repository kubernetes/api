...
type Container struct {
	...
	// More info: https://git.k8s.io/community/blob/master/contributors/design-proposals/auth/security_context.md
	// +optional
...
// see https://git.k8s.io/community/blob/master/contributors/design-proposals/scheduling/resources.md for more details.
